...
test.beforeEach(async ({ pages, newUsersData, articleWithoutTags }) => {
  await signUpUser(pages[0], newUsersData[0], 1);
  await signUpUser(pages[1], newUsersData[1], 2);
